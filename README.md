...
> KAMP 사출성형기 AI 데이터셋을 활용한 공정 불량 예측 모델 개발 및 단계별 Ablation 분석
...
**각 처리 단계를 분리해 어느 단계가 성능을 좌우하는지 정량적으로 측정**하는 것이 핵심 차별점입니다.
...
> **주의:** `data/raw/` 원본 CSV는 KAMP 저작권으로 인해 포함되지 않습니다.  
> [KAMP 플랫폼](https://www.kamp-ai.kr)에서 "사출성형기 AI 데이터셋"을 직접 다운로드하세요.
